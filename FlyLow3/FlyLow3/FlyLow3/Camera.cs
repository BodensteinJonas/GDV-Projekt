...
namespace FlyLow3
{
    class Camera
    {
        ...
        public float moveSpeed, rotateSpeed, rotation;
        ...
        public Camera(Vector3 cameraPosition, float moveSpeed, float rotateSpeed, float rotation, GraphicsDevice device)
        {
        ...
        public void Update()
        {
            ...
            {
                Vector3 v = new Vector3(0, -1, -1) * moveSpeed;
                move(v);
            ...
            {
                Vector3 v = new Vector3(-1, 0, 0) * rotation;
                move(v);
